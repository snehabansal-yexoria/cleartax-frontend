...
import { CoreApiError, getReportSummary } from "@/src/lib/coreApi";
...
export async function GET(req: Request) {
  ...
  try {
    const data = await getReportSummary(token, reportQuery(req));
    ...
    console.error("GET /api/reports/summary error:", message);
