                        ...
                        <form onSubmit={handleCreateTask} className="flex flex-col gap-5">
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <div className="relative flex items-center">
                                    ...
                                    <input
                                        ...
                                        className="w-full h-[50px] pl-11 pr-4 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#28336e]/10 focus:border-[#28336e] text-slate-800 text-sm placeholder-slate-300 font-semibold transition bg-slate-50/30 hover:bg-slate-50/80"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                {newTaskDeadlineError && (
                                    <div className="flex items-center gap-1.5 text-rose-600 mt-1 ml-1 animate-fadeIn">
                                        <svg className="w-3.5 h-3.5 text-rose-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.2">
                                            <circle cx="12" cy="12" r="10" />
                                            <line x1="12" y1="8" x2="12" y2="12" />
                                            <line x1="12" y1="16" x2="12.01" y2="16" />
                                        </svg>
                                        <span className="text-[0.78rem] font-semibold tracking-tight">{newTaskDeadlineError}</span>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="flex items-center justify-end gap-6 mt-4">
                                ...
                                <button
                                    ...
                                    className={`font-bold text-sm px-6 py-3 rounded-xl shadow-sm transition hover:-translate-y-0.5 cursor-pointer text-white ${newTaskName && newTaskDesc && newTaskDeadline && newTaskAssignee && !newTaskDeadlineError && !submitting
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                {editTaskDeadlineError && (
                                    <div className="flex items-center gap-1.5 text-rose-600 mt-1 ml-1 animate-fadeIn">
                                        ...
                                        <span className="text-[0.78rem] font-semibold tracking-tight">{editTaskDeadlineError}</span>
                                    </div>
                                )}
                            </div>
