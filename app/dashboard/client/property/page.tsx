...
import { formatCurrencyShort, getCurrencyPrefix } from "@/src/lib/currency";
    ...
    >
      ...
      >
        ...
        >
          ...
          <Link 
            href="/dashboard/client/property/new" 
            style={{
              display: "flex",
              alignItems: "center",
        ...
        {filteredProperties.length === 0 ? (
          ...
          <div className="property-cards-container">
            {filteredProperties.map((prop, idx) => {
              const formattedExpense = formatCurrencyShort(prop.expense).replace(getCurrencyPrefix(), "");
                    ...
                    <div className="m-db-property-stats-line">
                      ...
                      <div>
                        ...
                        <span className="m-db-property-stat-value expense">
                          -{getCurrencyPrefix()}{formattedExpense}
                        </span>
                      </div>
                    </div>
