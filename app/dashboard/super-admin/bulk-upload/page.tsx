...
const DEFAULT_HEADERS = ["organization", "admin_email", "full_name"];
    ...
    <section className="portal-page">
      <div className="portal-page-header">
        <div>
          ...
          <p>Import admins for organizations using a CSV or pasted rows.</p>
        </div>
      ...
      <div className="portal-list-card">
        <div className="portal-list-header">
          <div>
            <h2>Import Admins</h2>
            <p>Choose a file or paste organization, admin email, and optional name.</p>
          </div>
      ...
      {isModalOpen && (
        <div className="portal-modal-backdrop" role="presentation" onClick={closeModal}>
          <div
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="super-admin-bulk-upload-title"
            onClick={(event) => event.stopPropagation()}
          >
            <div className="portal-modal-header">
              <div>
                <p className="portal-kicker">Bulk Upload</p>
                <h2 id="super-admin-bulk-upload-title">Bulk Upload</h2>
            ...
            {inputMode === "csv" ? (
              <div className="portal-modal-section">
                <p className="portal-modal-help">
                  Upload a CSV with `organization`, `admin_email`, and optional `full_name`.
                </p>
                <input
              ...
              <div className="portal-modal-section">
                <p className="portal-modal-help">
                  Paste CSV, tab-separated data, or rows like `yexoria
                  admin@example.com Alex Morgan`.
                </p>
                <textarea
